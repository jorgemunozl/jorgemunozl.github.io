...
/**
 * arXiv mark (from Simple Icons, CC0 1.0).
 * @see https://simpleicons.org/
 */
type ArxivLogoProps = React.SVGProps<SVGSVGElement>;

const ArxivLogo = React.forwardRef<SVGSVGElement, ArxivLogoProps>(({ className, ...props }, ref) => {
  return (
    <svg
      ref={ref}
      viewBox="0 0 24 24"
...
ArxivLogo.displayName = 'ArxivLogo';

export default ArxivLogo;

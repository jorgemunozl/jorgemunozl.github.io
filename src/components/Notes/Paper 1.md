...
Vision is one of the amazing things that beings has. Emulate them via computers is a problem already fixed, but is still to expensive. How we fix that?
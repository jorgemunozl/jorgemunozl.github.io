...
Each node receive and _input_ and give an _output_ to the nodes that is connected.(This two are real numbers). There it's works equal that a [[Vectorial Function]].

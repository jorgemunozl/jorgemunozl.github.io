...
const Hero = () => {
  const contactLinks = [
    ...
    { href: 'https://x.com/jorgemunozla', title: 'X', icon: null, svg: 'x' },
    { href: 'https://github.com/jorgemunozl', title: 'GitHub', icon: Github },
    { href: 'https://huggingface.co/jorgemunozl', title: 'Hugging Face', icon: null, svg: 'huggingface' },
    { href: 'https://instagram.com/jorgemunozl', title: 'Instagram', icon: null, svg: 'instagram' },
  ];

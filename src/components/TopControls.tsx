    ...
    <div className="pointer-events-none fixed inset-x-0 top-0 z-50 flex items-start justify-between px-4 pt-2 sm:px-6">
      <div className="pointer-events-auto flex items-start gap-2">
        <button
          type="button"
          onClick={handleBack}
          className="flex h-12 w-12 items-center justify-center rounded-full border border-slate-600 bg-white/85 shadow-inner shadow-emerald-400/20 transition-transform duration-200 ease-out hover:-translate-y-0.5 hover:shadow-emerald-400/40 dark:border-white/10 dark:bg-transparent dark:shadow-purple-500/20 dark:hover:shadow-purple-500/35"
          aria-label="Go back"
        >
          <ArrowLeft className="h-5 w-5 text-slate-800 dark:text-white/90" />
        </button>
        <button
          type="button"
